package com.example.domain.origin.entities;
...
import com.example.domain.origin.schemas.ServiceInput;
 ...
 */
public abstract class SERVICE_Abstract<I, O> {
     ...
     */
    public SERVICE_Abstract(ServiceDependency dependencies) {
     ...
     */
    protected abstract USECASE_Abstract<I, O> build(I input);
    ...
    public ServiceOutput<O> run(ServiceInput<I> input) {
        ...
        try {
            ...
            // input.
            USECASE_Abstract<I, O> usecase = build(input.data());
